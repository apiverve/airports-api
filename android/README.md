...
```gradle
dependencies {
    implementation 'com.github.apiverve:airports-api:1.1.13'
}
```
...
```java
import com.apiverve.airports.AirportsLookupAPIClient;
import com.apiverve.airports.APIResponse;
import com.apiverve.airports.APIException;

// Initialize the client
AirportsLookupAPIClient client = new AirportsLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("iata", "MCI");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/airports](https://docs.apiverve.com/ref/airports)
...
- **Documentation:** [https://docs.apiverve.com/ref/airports](https://docs.apiverve.com/ref/airports)
- **Issues:** [GitHub Issues](https://github.com/apiverve/airports-api/issues)
