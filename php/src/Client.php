...
/**
 * Client for the Airports Lookup API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://airports.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/airports';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\AirportsClient] {$message}\n";
        }
    }
}
