...
namespace APIVerve.API.AirportsLookup
{
    ...
    /// <summary>
    /// Client for the AirportsLookup API
    /// </summary>
...
#endif
    {
        ...
        {
            { "iata", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public AirportsLookupAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public AirportsLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public AirportsLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        private void ValidateParams(AirportsLookupQueryOptions options)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(AirportsLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(AirportsLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(AirportsLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(AirportsLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(AirportsLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
