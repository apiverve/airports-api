...
const (
	baseURL        = "https://api.apiverve.com/v1/airports"
	defaultTimeout = 30 * time.Second
)

// Client is the Airports Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Airports Lookup API client.
...
// Execute makes a request to the Airports Lookup API with typed parameters.
//
