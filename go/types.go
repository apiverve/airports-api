// Package airports provides a Go client for the Airports Lookup API.
//
// For more information, visit: https://apiverve.com/marketplace/airports?utm_source=go&utm_medium=readme
package airports
...
// Request contains the parameters for the Airports Lookup API.
//
// Parameters:
//   - iata (required): string - The IATA code of the airport for which you want to get the information (e.g., MCI)
type Request struct {
	Iata string `json:"iata"` // Required
}
...
// ResponseData contains the data returned by the Airports Lookup API.
type ResponseData struct {
	...
	Tz string `json:"tz"`
	CityInfo CityInfoData `json:"city_info"`
}

// CityInfoData represents the city_info object.
