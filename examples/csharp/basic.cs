    ...
    class AirportsLookupExample
    {
        ...
        static async Task<JsonDocument> CallAirportsLookupAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;iata&quot;] &#x3D; &quot;MCI&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Airports Lookup API...\n");

            var result = await CallAirportsLookupAPI();
